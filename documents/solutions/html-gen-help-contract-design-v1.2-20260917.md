# html-gen help 契约治理设计 v1.2（help 单一事实源）
...
> 基线链: v1.0（`4649053`，CONDITIONAL PASS 80/B）→ v1.1（`ba7b547`，折入 HG-SEC-161..167，复审 CONDITIONAL PASS 85/B）→ **v1.2（折入 HG-SEC-168..171）**
> 评审报告: `documents/review/html-gen-help-contract-design-review-v1.0-20260917.md` / `…-v1.1-20260917.md`（已 push 至 `2ed8078`）
> 说明: v1.2 为**直接套用复审给定的修正**（其对账正则已由复审与 ops 双方实测，doc 9 / slide 8 / table 9 / knowledge 10 与 §3 清单逐项吻合），
> 按复审建议「折入 CL012/CL013 实施」，不另开评审轮次。
> 开放决策项: 无
