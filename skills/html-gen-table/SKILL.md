...
**type: "string"** (默认)
- 文本排序，使用 `localeCompare`
- 配合 `locale: "zh"` 实现中文拼音排序

**type: "number"**
- 数值排序，使用 `parseFloat` 比较
- 空值视为 0
...
### 编辑/修改
✏️ 编辑 · 📝 重命名 · 📁 移动 · 📌 置顶 · ⭐ 收藏 · 🔄 切换状态

### 操作/执行
▶️ 播放 · ⬇️ 下载 · 🚀 运行 · 🧬 克隆 · 📦 部署 · 🔨 构建

### 复制/分享
📋 复制内容 · 📎 复制链接 · 💻 复制命令 · 🗂️ 复制路径 · 📤 分享

### 删除/清理
🗑️ 删除 · 📥 归档 · 🧹 清理

### 信息/诊断
ℹ️ 元信息 · 📄 日志 · 📊 状态 · 🕐 历史 · 🔍 Diff
...
列可见性切换会重建表头，确保列的 `key` 唯一且不为空。actions 列不参与可见性切换。
